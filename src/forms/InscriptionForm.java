...
public class InscriptionForm {
    ...
    public Utilisateur inscrireUtilisateur( HttpServletRequest request ) {
        ...
        try {
            ...
            resultat = "…chec de l'inscription : une erreur imprÈvue est survenue, merci de rÈessayer dans quelques instants.";
            e.printStackTrace();
        }
    ...
    private void validationPseudo( String pseudo ) throws FormValidationException {
        if ( pseudo != null && pseudo.length() < 3 ) {
            throw new FormValidationException( "Le pseudo doit contenir au moins 3 caract√®res." );
        }
    }
